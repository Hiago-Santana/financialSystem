<template>
    <div class="border border-gray-200 rounded-md p-4 dark:border-gray-800">
        ...
        <div v-for="expenses in expense" :key="expenses.id" class="flex items-center justify-between mb-3">
            <!-- Category name -->
            <span class="text-sm text-gray-700 font-medium w-24 dark:text-gray-200">
            ...
            <div class="flex-1 mx-2">
                <div class="w-full bg-gray-200 rounded-full h-2 dark:bg-gray-800">
                    <div class="h-2 rounded-full bg-black dark:bg-gray-200"
            ...
            <!-- Value -->
            <span class="text-sm text-gray-700 font-medium w-20 text-right dark:text-gray-200">
